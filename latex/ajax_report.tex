...
\newcommand{\githubOne}{https://github.com/jorghee/tarea\_ajax}
\newcommand{\githubTwo}{https://github.com/jorghee/ajax\_markdown}
...
\include{markdown_report}
\include{part_edysson}
\include{part_victor}
\end{document}
